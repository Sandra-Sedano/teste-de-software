...
public class TecnicoServiceTests {
	...
	void setUp() throws Exception{
		...
		// Configura os comportamentos simulados ( que foi mocado)
		// Excluir dados
	...
	@Test
	public void updateDeveriaSalvarQuandoIdExistente() {
	...
	@Test
	public void findAllPagedDeveriaRetornarObjetoQuandoIdExistente(){
		TecnicoDTO dto =  service.findById(idExistente);
		 Assertions.assertNotNull(dto);
	}
	
	@Test
	public void deleteDeveriaLancarDataIntegrityViolationExceptionQuandoIdDependente() {
