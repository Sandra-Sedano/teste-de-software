...
public class TecnicoResourceTests {
	...
	public void findAllPagedDeveriaRetornarPage() throws Exception {
		ResultActions result = mocMvc.perform(get("/tecnicos").accept(MediaType.APPLICATION_JSON));
	...
	public void findByIdDeveriaRetornarTecnicoQuandoIdExistente() throws Exception {
		ResultActions result = mocMvc.perform(get("/tecnicos/{id}", idExistente).accept(MediaType.APPLICATION_JSON));
		result.andExpect(status().isOk());
	...
	public void findByIdDeveriaRetornarExceptionNotFoundQuandoIdInexistente() throws Exception {
		ResultActions result = mocMvc.perform(get("/tecnicos/{id}", idInexistente).accept(MediaType.APPLICATION_JSON));
		result.andExpect(status().isNotFound());
